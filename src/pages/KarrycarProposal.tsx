          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                <a href="mailto:a.danesin@critical-work.com" className="flex items-center gap-2 hover:text-foreground transition-colors">
                  <Mail className="w-4 h-4" />
                  a.danesin@critical-work.com
                </a>
                <a href="tel:+393389085895" className="flex items-center gap-2 hover:text-foreground transition-colors">
